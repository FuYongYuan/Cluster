...
public class JwtTokenUtil {
    ...
    public String getAccessToken(String subject, SecurityUser securityUser) {
        return generateToken(securityJwtProperties.getIssuer(), subject, securityUser, securityJwtProperties.getAccessTokenExpireTime().toMillis());
    }
