...
import ManagerDetail from "@/views/manager/Detail.vue";
import {ManagerDTO} from "DTO";
import {deleteManager, freezeManager, queryManager, recoverFreezeManager} from "@/apis/member/service";
...
export default defineComponent({
    ...
    setup() {
        ...
        const loading = async () => {
            ...
            // 判断是否显示恢复按钮
            manageData.searchFormData.showRecover = manageData.searchFormData.state === 1;
            // 结束
        ...
        const deleteAll = async () => {
            if (manageData.selectedRowKeys.length > 0) {
                ...
                manageData.loadingState = true;
                // 删除
                const result = await deleteManager(manageData.selectedRowKeys.join(","));
