...
import {getImageCaptcha} from "@/apis/message/service";
import {login, queryHaveMenu} from "@/apis/authorization/service";
    ...
    setup() {
        ...
        const loginFinish = async () => {
            ...
            if (result !== undefined) {
                ...
                if (result.headImgUrl !== undefined && result.headImgUrl !== null && result.headImgUrl !== "") {
                    localStorage.setItem(LocalStorageHeadImgUrl, result.headImgUrl);
                } else {
                    localStorage.setItem(LocalStorageHeadImgUrl, FailImage);
                }
                if (result.managerName !== undefined && result.managerName !== null && result.managerName !== "") {
                ...
                localStorage.setItem(LocalStorageAccountMenuList, JSON.stringify(menuList));
...
.login-container {
  ...
  &-form {
    ...
    margin-right: 20px;
    margin-left: 20px;
    background: #fff url("~@/assets/images/login/login_form.png");
