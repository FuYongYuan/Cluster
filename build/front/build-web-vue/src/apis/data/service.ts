...
import {DataBaseURL, SuccessRequestCode} from "@/apis/commons/constant";
...
export const uploadFormData = (
    ...
    return request.upload(
        ...
        (progressEvent) => {
            ...
            // 单一次跳动计算公式
            const speed = parseInt((100 / (options.file.size / 65000) * progressEvent.loaded / progressEvent.total).toFixed(0));
            // 定时跳动进度条
