...
import {getManagerByJwtToken} from "@/apis/member/service";
import {FormInstance, message} from "ant-design-vue";
import {ImageCaptchaDTO, MailCaptchaDTO} from "DTO";
import {RuleObject} from "ant-design-vue/es/form";
import {FailImage} from "@/apis/commons/constant";
import {getImageCaptcha, getMailCaptcha} from "@/apis/message/service";
import {mailFormatValidate} from "@/utils/validate/regex";
import {Md5} from "ts-md5";
import {recover} from "@/apis/authorization/service";
import {showSuccessNotification} from "@/antd/notification";
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const handleOk = async () => {
            detail.value?.validate().then(async () => {
                const {
                    mail,
                    password,
                    mailCaptcha,
                ...
                const mailCaptchaCacheName = detailData.mailCaptchaDTO.captchaCacheName;
