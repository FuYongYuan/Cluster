...
INSERT INTO `his_config_info` (`id`, `nid`, `data_id`, `group_id`, `app_name`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `op_type`, `tenant_id`, `encrypted_data_key`) VALUES (15,61,'authorization-data-test.yaml','service','authorization','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: cn.fyy.authorization.repository\n    # 数据模型目录\n    dbo-path: cn.fyy.authorization.bean.dbo\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.authorization.service.impl.*,cn.fyy.authorization.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/authorization?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/authorization?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','9c3e7a21a0918fd366452fd8eb057a32','2025-08-07 12:18:31','2025-08-07 20:18:32','fyy','192.168.65.1','U','7',''),(18,62,'builder-data-test.yaml','service','builder','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: \'cn.fyy.builder.repository\'\n    # 数据模型目录\n    dbo-path: cn.fyy.builder.bean.dbo\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.builder.service.impl.*,cn.fyy.builder.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/builder?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/builder?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','a0965b415ee08a81fefaf21f4e704db9','2025-08-07 12:18:47','2025-08-07 20:18:48','fyy','192.168.65.1','U','7',''),(20,63,'capability-data-test.yaml','service','capability','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: \'cn.fyy.capability.repository\'\n    # 数据模型目录\n    dbo-path: \'cn.fyy.capability.bean.dbo\'\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.capability.service.impl.*,cn.fyy.capability.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/capability?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/capability?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','e0f5d06bb2236e1afdf2566f179d9b80','2025-08-07 12:19:12','2025-08-07 20:19:12','fyy','192.168.65.1','U','7',''),(18,64,'builder-data-test.yaml','service','builder','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: \'cn.fyy.builder.repository\'\n    # 数据模型目录\n    po-path: cn.fyy.builder.bean.po\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.builder.service.impl.*,cn.fyy.builder.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/builder?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/builder?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','a3e98bac0fd20fdc3b989e1ba952c92e','2025-08-07 12:20:17','2025-08-07 20:20:17','fyy','192.168.65.1','U','7',''),(15,65,'authorization-data-test.yaml','service','authorization','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: cn.fyy.authorization.repository\n    # 数据模型目录\n    po-path: cn.fyy.authorization.bean.po\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.authorization.service.impl.*,cn.fyy.authorization.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/authorization?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/authorization?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','201ffa94a2cd1d52d55daebf785a103b','2025-08-07 12:20:44','2025-08-07 20:20:45','fyy','192.168.65.1','U','7',''),(23,66,'dictionary-data-test.yaml','service','dictionary','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: \'cn.fyy.dictionary.repository\'\n    # 数据模型目录\n    dbo-path: \'cn.fyy.dictionary.bean.dbo\'\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.dictionary.service.impl.*,cn.fyy.dictionary.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/dictionary?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/dictionary?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','e9ff02d687dc4b7468fc20e351ffa7ca','2025-08-07 12:21:25','2025-08-07 20:21:26','fyy','192.168.65.1','U','7',''),(25,67,'member-data-test.yaml','service','member','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: cn.fyy.member.repository\n    # 数据模型目录\n    dbo-path: cn.fyy.member.bean.dbo\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.member.service.impl.*,cn.fyy.member.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/member?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/member?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','3f5fa9d7c4cbcb40780db3f030dfe6c0','2025-08-07 12:21:54','2025-08-07 20:21:55','fyy','192.168.65.1','U','7',''),(27,68,'message-data-test.yaml','service','message','spring:\n  # JPA设置\n  jpa:\n    hibernate:\n      # 运行时对表得操作\n      # create 启动时删数据库中的表，然后创建，退出时不删除数据表\n      # create-drop 启动时删数据库中的表，然后创建，退出时删除数据表 如果表不存在报错\n      # update 如果启动时表格式不一致则更新表，原有数据保留\n      # validate 项目启动表结构进行校验 如果不一致则报错\n      ddl-auto: update\n    # sql执行是否打印\n    show-sql: true\n    # 设置参数\n    properties:\n      hibernate:\n        # 格式化sql\n        format_sql: fales\n    # 打开视图\n    open-in-view: true\n    # 数据层目录\n    repository-path: cn.fyy.message.repository\n    # 数据模型目录\n    dbo-path: cn.fyy.message.bean.dbo\n\n  # 数据源配置\n  datasource:\n    type: com.alibaba.druid.pool.DruidDataSource\n    druid:\n      # 拦截器\n      web-stat-filter:\n        # 是否启用\n        enabled: true\n        # 经常需要排除一些不必要的url，比如*.js,/jslib/*等等\n        exclusions: \'*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*\'\n        # 配置profileEnable能够监控单个url调用的sql列表\n        profile-enable: true\n        # 关闭session统计功能\n        session-stat-enable: false\n        # 拦截地址\n        url-pattern: /*\n      # 统计配置\n      stat-view-servlet:\n        # 是否启用\n        enabled: true\n        # 统计页面登录账号\n        login-password: fyy\n        # 统计页面登录密码\n        login-username: fyyain77\n        # 是否允许清空统计数据\n        reset-enable: false\n        # 访问地址\n        url-pattern: /druid/*\n        # 允许访问IP\n        allow:\n        # 拒绝访问IP\n        deny:\n      # AOP切面\n      aop-patterns: \'cn.fyy.message.service.impl.*,cn.fyy.message.repository.*\'\n      # 用户数据库读数据源\n      read:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/message?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 读取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: false\n              # 是否允许执行UPDATE语句\n              update-allow: false\n              # 是否允许执行INSERT语句\n              insert-allow: false\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: false\n              # 是否允许使用SET语法\n              set-allow: false\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: false\n              # 是否允许执行Alter Table语句\n              alter-table-allow: false\n              # 是否允许修改表\n              drop-table-allow: false\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: false\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: false\n              # 是否允许执行roll back操作\n              rollback-allow: false\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n      # 用户数据库写数据源\n      write:\n        # 连接驱动\n        driver-class-name: com.mysql.cj.jdbc.Driver\n        # 数据库地址\n        url: jdbc:mysql://127.0.0.1:3306/message?useUnicode=true&useSSL=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n        # 数据库账号\n        username: root\n        # 数据库密码\n        password: fyyain77\n        # 初始化连接大小\n        initial-size: 10\n        # 连接最小数\n        min-idle: 10\n        # 连接最大数\n        max-active: 100\n        # 获取连接等待超时的时间\n        max-wait: 60000\n        # 启用连接池资源释放\n        keep-alive: true\n        # 用来检测连接是否有效的sql，要求是一个查询语句，常用select \'x\'。如果validationQuery为null，testOnBorrow、testOnReturn、testWhileIdle都不会起作用。\n        validation-query: select \'x\'\n        # 申请连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-borrow: false\n        # 归还连接时执行validationQuery检测连接是否有效，做了这个配置会降低性能。\n        test-on-return: false\n        # 建议配置为true，不影响性能，并且保证安全性。申请连接的时候检测，如果空闲时间大于timeBetweenEvictionRunsMillis，执行validationQuery检测连接是否有效。\n        test-while-idle: true\n        # 有两个含义：\n        #1) Destroy线程会检测连接的间隔时间，如果连接空闲时间大于等于minEvictableIdleTimeMillis则关闭物理连接。\n        #2) testWhileIdle的判断依据，详细看testWhileIdle属性的说明\n        time-between-eviction-runs-millis: 60000\n        # 连接保持空闲而不被驱逐的最小时间\n        min-evictable-idle-time-millis: 300000\n        # 连接泄漏监测 在内置监控页面weburi-detail.html中，查看JdbcPoolConnectionOpenCount和JdbcPoolConnectionCloseCount属性，如果不相等，就是泄漏了。\n        remove-abandoned: false\n        remove-abandoned-timeout: 1800\n        log-abandoned: true\n        # 属性类型是字符串，通过别名的方式配置扩展插件，常用的插件有：\n        # 监控统计用的filter:stat\n        # 日志用的filter:log4j\n        # 防御sql注入的filter:wall\n        filters: stat,slf4j,wall\n        # 细致化配置\n        # 写取拦截sql配置\n        filter:\n          stat:\n            # 是否记录慢SQL\n            log-slow-sql: true\n            # 记录多慢的SQL，毫秒\n            slow-sql-millis: 3000\n            # 合并SQL\n            merge-sql: true\n          wall:\n            # 是否启用\n            enabled: true\n            # 数据库类型\n            db-type: mysql\n            # 对被认为是攻击的SQL进行LOG.error输出\n            log-violation: true\n            # 对被认为是攻击的SQL抛出SQLExcepton\n            throw-exception: true\n            # 拦截配置\n            config:\n              # 拦截语句\n              # 是否允许执行SELECT语句\n              selelct-allow: true\n              # 是否允许执行SELECT * FROM T这样的语句。如果设置为false，不允许执行select * from t，但select * from (select id, name from t) a。这个选项是防御程序通过调用select *获得数据表的结构信息。\n              select-all-column-allow: true\n              # SELECT查询中是否允许INTO字句\n              select-into-allow: false\n              # 是否允许执行DELETE语句\n              delete-allow: true\n              # 是否允许执行UPDATE语句\n              update-allow: true\n              # 是否允许执行INSERT语句\n              insert-allow: true\n              # 是否允许执行REPLACE语句\n              replace-allow: true\n              # 是否允许通过jdbc的call语法调用存储过程\n              call-allow: true\n              # 是否允许使用SET语法\n              set-allow: true\n              # truncate语句是危险(删除所有数据无法回滚)，缺省打开，若需要自行关闭\n              truncate-allow: false\n              # 是否允许创建表\n              create-table-allow: true\n              # 是否允许执行Alter Table语句\n              alter-table-allow: true\n              # 是否允许修改表\n              drop-table-allow: true\n              # 是否允许语句中存在注释，Oracle的用户不用担心，Wall能够识别hints和注释的区别\n              comment-allow: false\n              # 是否允许非以上基本语句的其他语句，缺省关闭，通过这个选项就能够屏蔽DDL。\n              none-base-statement-allow: false\n              # 是否允许一次执行多条语句，缺省关闭\n              multi-statement-allow: true\n              # 是否允许执行mysql的use语句，缺省打开\n              use-allow: false\n              # 是否允许执行mysql的describe语句，缺省打开\n              describe-allow: false\n              # 是否允许执行mysql的show语句，缺省打开\n              show-allow: false\n              # 是否允许执行commit操作\n              commit-allow: true\n              # 是否允许执行roll back操作\n              rollback-allow: true\n              # 永真条件\n              # 检查SELECT语句的WHERE子句是否是一个永真条件\n              select-where-alway-true-check: true\n              # 检查SELECT语句的HAVING子句是否是一个永真条件\n              select-having-alway-true-check: true\n              # 检查DELETE语句的WHERE子句是否是一个永真条件\n              delete-where-alway-true-check: true\n              # 检查DELETE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              delete-where-none-check: true\n              # 检查UPDATE语句的WHERE子句是否是一个永真条件\n              update-where-alay-true-check: true\n              # 检查UPDATE语句是否无where条件，这是有风险的，但不是SQL注入类型的风险\n              update-where-none-check: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永真条件\n              condition-and-alway-true-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含AND永假条件\n              condition-and-alway-false-allow: true\n              # 检查查询条件(WHERE/HAVING子句)中是否包含LIKE永真条件\n              condition-like-true-allow: true\n              # 其他配置\n              # SELECT ... INTO OUTFILE 是否允许，这个是mysql注入攻击的常见手段，缺省是禁止的\n              select-into-outfile-allow: false\n              # 检测SELECT UNION\n              select-union-check: true\n              # 检测SELECT MINUS\n              select-minus-check: true\n              # 检测SELECT EXCEPT\n              select-except-check: true\n              # 检测SELECT INTERSECT\n              select-intersect-check: true\n              # 是否必须参数化，如果为True，则不允许类似WHERE ID = 1这种不参数化的SQL\n              must-parameterized: false\n              # 是否进行严格的语法检测，Druid SQL Parser在某些场景不能覆盖所有的SQL语法，出现解析SQL出错，可以临时把这个选项设置为false，同时把SQL反馈给Druid的开发者。\n              strict-syntax-check: true\n              # 查询条件中是否允许有XOR条件。XOR不常用，很难判断永真或者永假，缺省不允许。\n              condition-op-xor-allow: false\n              # 查询条件中是否允许有\"&\"、\"~\"、\"|\"、\"^\"运算符。\n              condition-op-bitwse-allow: true\n              # 查询条件中是否允许连续两个常量运算表达式\n              condition-double-const-allow: true\n              # 是否允许SELECT * FROM A MINUS SELECT * FROM B这样的语句\n              minus-allow: true\n              # 是否允许SELECT * FROM A INTERSECT SELECT * FROM B这样的语句\n              intersect-allow: true\n              # 拦截常量运算的条件，比如说WHERE FID = 3 - 1，其中\"3 - 1\"是常量运算表达式。\n              const-arithmetic-allow: true\n              # 是否允许limit 0这样的语句\n              limit-zero-allow: false\n              # 配置最大返回行数，如果select语句没有指定最大返回行数，会自动修改selct添加返回限制\n              select-limit: -1\n              # 禁用对象检测配置\n              # 检测是否使用了禁用的表\n              table-check: true\n              # 检测是否使用了禁用的Schema\n              schema-check: true\n              # 检测是否使用了禁用的函数\n              function-check: true\n              # 检测是否使用了“禁用对对象”\n              object-check: true\n              # 检测是否使用了“禁用的变量”\n              variant-check: true\n              # 指定的表只读，不能够在SELECT INTO、DELETE、UPDATE、INSERT、MERGE中作为\"被修改表\"出现<\n              read-only-tables:\n              # JDBC相关配置\n              # 是否允许调用Connection.getMetadata方法，这个方法调用会暴露数据库的表信息  false会导致报错但不影响功能使用\n              metadata-allow: true\n              # 是否允许调用Connection/Statement/ResultSet的isWrapFor和unwrap方法，这两个方法调用，使得有办法拿到原生驱动的对象，绕过WallFilter的检测直接执行SQL。\n              wrap-allow: false\n\n# 分布式事务\nseata:\n  application-id: seata-${spring.application.name}-${spring.profiles.active}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${spring.cloud.nacos.discovery.namespace}\n      cluster-name: ${spring.cloud.nacos.discovery.cluster-name}\n      # 分组\n      group: system\n      # Nacos 中 Seata 名称\n      application: seata-server\n  # 事务组（被一个集群管理）\n  tx-service-group: seata_tx_group\n  service:\n    vgroup-mapping:\n      # 映射到默认的服务分组-名字同上\n      seata_tx_group: default\n  # 实现 AT 模式\n  data-source-proxy-mode: AT','953d85d6fed256ad5d57fddb16a84c02','2025-08-07 12:22:19','2025-08-07 20:22:20','fyy','192.168.65.1','U','7','');
...
-- Dump completed on 2025-08-07 12:31:46
