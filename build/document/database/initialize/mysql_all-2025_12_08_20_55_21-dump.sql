...
CREATE TABLE `undo_log` (
  ...
  UNIQUE KEY `ux_undo_log` (`xid`,`branch_id`),
  KEY `ix_log_created` (`log_created`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='AT事务模式撤销表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='config_tag_relation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `config_tags_relation` (`id`, `tag_name`, `tag_type`, `data_id`, `group_id`, `tenant_id`, `nid`) VALUES (10,'认证配置','','jwt-test.yaml','system','7',22),(13,'链接配置','','mail-test.yaml','system','7',26),(16,'链接配置','','redis-test.yaml','system','7',31),(14,'链接配置','','minio-test.yaml','system','7',86),(28,'链接配置','','rocketmq-test.yaml','system','7',114),(29,'链接配置','','mongodb-test.yaml','system','7',115),(30,'链接配置','','elasticsearch-test.yaml','system','7',117),(31,'服务配置','','seata-server-test.yaml','system','7',125),(33,'链接配置','','job-xxl-test.yaml','service','7',136),(32,'基础配置','','job-base-test.yaml','service','7',137),(26,'基础配置','','message-base-test.yaml','service','7',138),(24,'基础配置','','member-base-test.yaml','service','7',139),(22,'基础配置','','dictionary-base-test.yaml','service','7',140),(21,'基础配置','','data-base-test.yaml','service','7',141),(19,'基础配置','','capability-base-test.yaml','service','7',142),(17,'基础配置','','builder-base-test.yaml','service','7',143),(7,'基础配置','','gateway-base-test.yaml','service','7',144),(5,'基础配置','','authorization-base-test.yaml','service','7',145),(20,'链接配置','','capability-data-test.yaml','service','7',148),(18,'链接配置','','builder-data-test.yaml','service','7',149),(15,'链接配置','','authorization-data-test.yaml','service','7',150),(23,'链接配置','','dictionary-data-test.yaml','service','7',151),(25,'链接配置','','member-data-test.yaml','service','7',152),(27,'链接配置','','message-data-test.yaml','service','7',153);
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='多租户改造';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `company_key`
--

DROP TABLE IF EXISTS `company_key`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `company_key` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `company_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '公司名称',
  `secret_key` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '密钥',
  `expiration_time` datetime NOT NULL COMMENT '过期时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='公司密钥表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `company_key`
--

LOCK TABLES `company_key` WRITE;
/*!40000 ALTER TABLE `company_key` DISABLE KEYS */;
INSERT INTO `company_key` (`id`, `company_name`, `secret_key`, `expiration_time`) VALUES (1,'钢铁中心','钢铁中心1号','2030-12-31 23:59:59');
/*!40000 ALTER TABLE `company_key` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_operation_logs` (
  ...
  `write_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '数据写入时间',
  `serialNumber` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '流水号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_operation_logs` (`id`, `username`, `operation_time`, `company_name`, `write_time`, `serialNumber`) VALUES (3,'string','2025-04-10 07:38:37','string','2025-04-10 15:41:03','string'),(4,'string','2025-04-10 07:38:37','string','2025-04-10 15:41:03','string'),(5,'string','2025-04-10 07:38:37','string','2025-04-10 15:47:18','string'),(6,'string','2025-04-10 07:38:37','string','2025-04-10 15:47:18','string');
...
INSERT INTO `xxl_job_group` (`id`, `app_name`, `title`, `address_type`, `address_list`, `update_time`) VALUES (3,'build-xxl-job-executor','build定时任务执行器',0,NULL,'2025-12-04 20:13:10');
...
INSERT INTO `xxl_job_log_report` (`id`, `trigger_day`, `running_count`, `suc_count`, `fail_count`, `update_time`) VALUES (1,'2025-06-27 00:00:00',0,0,0,NULL),(2,'2025-06-26 00:00:00',0,0,0,NULL),(3,'2025-06-25 00:00:00',0,0,0,NULL),(4,'2025-06-28 00:00:00',0,0,0,NULL),(5,'2025-06-29 00:00:00',0,0,0,NULL),(6,'2025-06-30 00:00:00',0,0,0,NULL),(7,'2025-07-01 00:00:00',0,0,0,NULL),(8,'2025-08-08 00:00:00',0,0,0,NULL),(9,'2025-08-07 00:00:00',0,0,0,NULL),(10,'2025-08-06 00:00:00',0,0,0,NULL),(11,'2025-08-09 00:00:00',0,0,0,NULL),(12,'2025-08-21 00:00:00',0,0,0,NULL),(13,'2025-08-20 00:00:00',0,0,0,NULL),(14,'2025-08-19 00:00:00',0,0,0,NULL),(15,'2025-08-22 00:00:00',0,0,0,NULL),(16,'2025-08-23 00:00:00',0,0,0,NULL),(17,'2025-08-26 00:00:00',0,0,0,NULL),(18,'2025-08-25 00:00:00',0,0,0,NULL),(19,'2025-08-24 00:00:00',0,0,0,NULL),(20,'2025-10-15 00:00:00',0,0,0,NULL),(21,'2025-10-14 00:00:00',0,0,0,NULL),(22,'2025-10-13 00:00:00',0,0,0,NULL),(23,'2025-10-16 00:00:00',0,0,0,NULL),(24,'2025-10-17 00:00:00',0,0,0,NULL),(25,'2025-10-18 00:00:00',0,0,0,NULL),(26,'2025-12-03 00:00:00',0,0,0,NULL),(27,'2025-12-02 00:00:00',0,0,0,NULL),(28,'2025-12-01 00:00:00',0,0,0,NULL),(29,'2025-12-04 00:00:00',0,0,0,NULL);
...
--
-- Current Database: `Yearning`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `Yearning` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `core_accounts` (
  ...
  `query_password` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `secret_key` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `core_auto_tasks` (
  ...
  `source_id` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `data_base` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `table` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `tp` tinyint NOT NULL,
  `affectrow` int DEFAULT NULL,
  `status` tinyint DEFAULT NULL,
  `task_id` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `id_c` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `core_data_sources` (
  ...
  `source_id` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `exclude_db_list` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `insulate_word_list` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `principal` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `ca_file` longtext COLLATE utf8mb4_general_ci,
  `cert` longtext COLLATE utf8mb4_general_ci,
  `key_file` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `core_global_configurations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `authorization` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `board` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `core_order_comments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `work_id` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `username` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `core_query_orders` (
  ...
  `approval_time` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `text` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `assigned` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `core_query_records` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `work_id` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `sql` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `ex_time` int NOT NULL,
  `time` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `source` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `schema` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `workId_idx` (`work_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `core_role_groups` (
  ...
  `group_id` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `core_sql_orders` (
  ...
  `sql` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `text` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `assigned` varchar(550) COLLATE utf8mb4_general_ci NOT NULL,
  `delay` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'none',
  `real_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `execute_time` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `current_step` int DEFAULT NULL,
  `relevant` json DEFAULT NULL,
  `osc_info` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `core_workflow_details` (
  ...
  `username` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `time` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `action` varchar(550) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  KEY `workId_idx` (`work_id`),
  KEY `query_idx` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Dump completed on 2025-12-08 12:55:22
